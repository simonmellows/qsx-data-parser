...
namespace QsxDataExtractor_ConsoleApp_
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string fileText = File.ReadAllText($@"C:\Users\simon.mellows\Desktop\Programming\C#\qsx-data-parser\Config Files\Integration Report.csv");
            ...
            foreach (var Area in Areas)
            {
                Console.WriteLine($"Area: {Area.AreaName}, Href: {Area.Href}, Name: {Area.AreaName}");
                ...
                if (Area.ShadeGroups != null)
                {
                    Console.WriteLine($"Number of Shade Groups: {Area.ShadeGroups.Count}");
                    foreach (var ShadeGroup in Area.ShadeGroups)
                    {
                        Console.WriteLine($"Shade Group: {ShadeGroup.Name}, Href: {ShadeGroup.Href}, Label: {ShadeGroup.Label}");
                    }
                }
            }
