...
namespace UserModule_CF_LUTRON_SHADEGROUPS_V2_0
{
    public class UserModuleClass_CF_LUTRON_SHADEGROUPS_V2_0 : SplusObject
    {
    ...
    public UserModuleClass_CF_LUTRON_SHADEGROUPS_V2_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
